...
import static seedu.coursepilot.testutil.TypicalIndexes.INDEX_THIRD_STUDENT;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_MATRIC_DESC, MatricNumber.MESSAGE_CONSTRAINTS); // invalid address
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_MATRIC_AMY + VALID_PHONE_AMY,
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditStudentDescriptorBuilder().withMatriculationNumber(VALID_MATRIC_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        assertParseFailure(parser, userInput,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE, PREFIX_EMAIL, PREFIX_MATRICNUMBER));
